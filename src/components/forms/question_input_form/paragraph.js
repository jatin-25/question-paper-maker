...
const PGQuestionForm = (props) => {
    ...
    let inputForm = (
        <div>
            ...
            <input type="text" onChange={(e) => onChangeQuestionHandler(e)} value={questionData.question}></input>
            <br></br>
        </div>
    )
    ...
    return (
        <div className="Text">
            ...
            <button onClick={() => updateQuestionArr()} className="Button">Submit</button>
            <button onClick={cancelButtonHandler} className="Button">Cancel</button>
        </div>
    );
}
